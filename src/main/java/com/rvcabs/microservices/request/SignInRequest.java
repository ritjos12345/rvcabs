...
public class SignInRequest implements Serializable{
	...
	@ApiModelProperty(notes = "User's Sign-In Id", required = true, allowEmptyValue = false, example = "Siva")
	...
	@ApiModelProperty(notes = "Password of the  user ", required = true, allowEmptyValue = false, example = "Abc@12def")
